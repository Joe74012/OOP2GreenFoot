...
public class Mauritius extends World
{
    ...
    Scoreboard scoreboard = new Scoreboard("Moves left:", 40, "Score:", 0);
    ...
    public void updateScore(int scores, int scores2){
        scoreboard.updateScore(scores,scores2);
    }
    ...
    public List<SurpriseEgg> maakLijstMetSupriseEieren(int aantal) {
